...
public struct hwLightData
{
	...
	public Matrix4x4 lightWorldToTex;
    public int type;
    int pad0, pad2, pad3;
...
public static class HairWorksIntegration
{
	...
	[DllImport ("HairWorksIntegration")] public static extern void          hwRenderShadow(hwHInstance iid, IntPtr shadowMap);
	...
	[DllImport ("HairWorksIntegration")] public static extern void          hwInitShadows(int resolution, IntPtr shadowMap);
	[DllImport ("HairWorksIntegration")] public static extern void          hwPrepareRenderTarget();
	[DllImport ("HairWorksIntegration")] public static extern void          hwPrepareShadowTarget();
